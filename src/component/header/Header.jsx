        ...
        <div className='absolute max-w-[1920px] w-full md:top-2 z-20'>
            <div className="header flex justify-between items-center px-2 md:px-7 py-1.5">
                ...
                <div className="right flex items-center jystify-center gap-3 md:gap-5">
                    ...
                    <div className="menuButton flex justify-center items-center gap-1 md:gap-2 py-1 md:py-2 px-3 md:px-5 hover:py-0.5 md:hover:py-1.5 hover:px-[10px] md:hover:px-[18px] overflow-hidden text-white font-bold bg-gradient-to-l from-[#1e1d8ae8] to-sky-500 cursor-pointer hover:bg-none hover:border-2 hover:border-sky-500" onClick={() => setShowMenubar(!showMenubar)}>
