    ...
    return (
        <div>
            <div className="projectSection" id="projects">
                <div className="projectArea flex flex-col items-center justify-center px-10 relative pb-10">
                    ...
                    <div className="leptopArea mt-10">
                        <div className="laptopFirst flex justify-center flex-wrap md:flex-nowrap gap-5 md:gap-40 relative">
                            ...
                            <div className="centerLine h-0.5 bg-red-500 absolute top-1/2 left-60 right-1/2 -z-20 hidden md:block"></div>
                        ...
                        <div className="laptopSecond flex justify-center flex-wrap md:flex-nowrap gap-5 md:gap-40 mt-10 relative">
                            <div className="projectDetails flex flex-col items-center justify-center w-3/4 md:w-full order-2 order md:order-none">
                                <div className="projectTitle relative group">
                            ...
                            <div className="centerLine h-0.5 bg-sky-500 absolute top-1/2 right-60 left-1/2 -z-20"></div>
                    ...
                    <div className='miniProjectArea mt-10 flex justify-center flex-wrap md:flex-nowrap gap-5 md:gap-40 w-full relative'>
